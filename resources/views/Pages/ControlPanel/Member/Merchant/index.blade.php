<x-Layout.Vertical.Master>
    ...
    <div class="row">
        ...
        <div class="col-6 col-md-6 col-lg-6 col-xl-3 mb-3">
            ...
            <x-Layout.Item.ProductItem :image="$ads->image" :title="$ads->title" :area="$ads->area" :jk="$ads->jk" :price="$ads->price" :jkm="$ads->jkm" :lb="$ads->lb" :lt="$ads->lt" :address="$ads->address" :type="$ads->type" :area="$ads->area" :linkTujuan="route('listing.control-panel.marchant.edit.tentang-marchant', ['slug' => $ads->slug])">
