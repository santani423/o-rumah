    ...
    <div class="table-container">
        <table class="table">
            ...
            <tbody>
                ...
                <tr
                    v-for="(websiteAdsSections, index) in websiteAdsSections"
                    :key="websiteAdsSections.id"
                >
                    <td>{{ index + 1 }}</td>

                    <td>
                        <p>{{ websiteAdsSections.name }}</p>
                    </td>
                    <td>{{ websiteAdsSections.description }}</td>
                    <td>
                        <label
                            class="switch"
                            @click="toggleActive(websiteAdsSections)"
                        >
                            <input
                                type="checkbox"
                                :checked="websiteAdsSections.is_active == 1"
                                disabled
                            />
