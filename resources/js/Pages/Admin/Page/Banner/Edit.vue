...
const name = ref(props.banner.name || "");
const id = ref(props.banner.id || "");
const description = ref(props.banner.description || "");
const url = ref(props.banner.url || "");
const image = ref("");
const is_active = ref(props.banner.is_active || true);
const show_on = ref(props.banner.show_on || "homepage");
const order = ref(props.banner.order || null);
const addBanner = () => {
    ...
    axios
        .post(route("admin.nav.banner.updated", id.value), formData, {
            headers: {
