...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('zenter/horizontal/assets/images/favicon.ico')}}">
    ...
    <body>
        ...
        <script src="{{ asset('zenter/horizontal/assets/js/jquery.slimscroll.js')}}"></script>
        <script src="{{ asset('zenter/horizontal/assets/js/jquery.nicescroll.js')}}"></script>
        <script src="{{ asset('zenter/horizontal/assets/js/jquery.scrollTo.min.js')}}"></script>
