    ...
    <div class="col m-0">
        <div class="card rounded-0 border border-1">
            <div class="card-body text-center pr-2 pl-2">
                ...
                <h6 class="mt-0" style="  font-size: 70%;">{{ $totalProperties }}</h6>
            </div>
        </div>
    </div>
    <div class="col m-0">
        <div class="card rounded-0 border border-1">
            <div class="card-body text-center pr-2 pl-2">
                ...
                <h6 class="mt-0" style="  font-size: 70%;">{{ $total_sold_properties }}</h6>
            </div>
        </div>
    </div>
    <div class="col m-0">
        <div class="card rounded-0 border border-1 pr-0 pl-0 mr-0 ml-0">
            <div class="card-body text-center">
                ...
                <h6 class="mt-0" style="  font-size: 70%;">{{ $total_rented_properties }}</h6>
            </div>
        </div>
    </div>
</div>
