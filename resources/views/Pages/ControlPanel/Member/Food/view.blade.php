                                        ...
                                        @foreach($media as $key => $md)
                                            <div class="col-md-4 mb-4">
                                                ...
                                                @if($ads['image'] != $md['url'])
                                                    ...
                                                    <!--  route('listing.control-panel.food.set.media.utama', ['ads_foodes_id' => $ads['ads_foodes_id']])  -->
                                                        @csrf
                                                        @method('PUT')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                <form id="mediaForm" action="" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <!-- route('listing.control-panel.food.set.media.update', ['ads_foodes_id' => $ads['ads_foodes_id']])  -->
                                                    @method('PUT')
