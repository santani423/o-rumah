...
import Datauser from "@/Pages/Admin/Page/Pengguna/DataPengguna.vue";
import { defineProps } from "vue";

// Define props to receive data from parent component
const props = defineProps({
    user: Array, // Menggunakan Array untuk menerima array of objects user
});

// Debugging to check props received
console.log("Received user:", props);
</script>
