<x-Layout.Vertical.Master title="Edit Merchant">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            @endif
            <form action="{{ route('listing.control-panel.Merchant.update', $ads['ads_id']) }}" method="post" enctype="multipart/form-data">
