...
class AuthController extends Controller
{
    ...
    public function inLogin(Request $request)
    {
        try {
            ...
            $error =  Log::error('Error during login: ' . $e->getMessage());
            // Mengembalikan response JSON dengan error detail
            return response()->json([
                'message' => 'Terjadi kesalahan saat login. Silakan coba lagi.',
                'error' => $e->getMessage(), // Mengirimkan pesan kesalahan
                'line' => $e->getLine(),     // Baris error terjadi
