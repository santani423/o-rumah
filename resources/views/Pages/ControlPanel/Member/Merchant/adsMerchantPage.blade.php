<x-Layout.Vertical.Master>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Tambah Iklan Merchant</h4>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            @endif
            <form action="{{route('member.merchants.store.listing')}}" method="post" enctype="multipart/form-data">
                ...
                <x-Layout.Item.FormKategoriMarchent>
                </x-Layout.Item.FormKategoriMarchent>
