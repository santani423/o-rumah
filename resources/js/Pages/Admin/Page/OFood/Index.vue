    ...
    <ListingLayout>
        ...
        <div class="pb-36">
            <div class="bg-white shadow-md rounded-lg p-4">
                ...
                >
                    <h3 class="text-xl font-semibold text-gray-800">O Food</h3>
...
import DataOfood from "@/Pages/Admin/Page/OFood/DataOfood.vue";
import { defineProps } from "vue";

// Define props to receive data from parent component
const props = defineProps({
    OFood: Array, // Menggunakan Array untuk menerima array of objects OFood
});

// Debugging to check props received
console.log("Received OFood:", props);
</script>
