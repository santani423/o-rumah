    ...
    <ListingLayout>
        ...
        <div class="pb-36">
            <div class="bg-white shadow-md rounded-lg p-4">
                ...
                >
                    <h3 class="text-xl font-semibold text-gray-800">Bank</h3>
                ...
                <div>
                    ...
                    <DataWebsiteAdsSection
                        :websiteAdsSections="websiteAdsSections"
                    />
                </div>
            </div>
        </div>
...
import DataWebsiteAdsSection from "@/Pages/Admin/Page/WebsiteAdsSection/DataWebsiteAdsSection.vue";
import { defineProps } from "vue";

// Define props to receive data from parent component
const props = defineProps({
    websiteAdsSections: Array, // Menggunakan Array untuk menerima array of objects bank
});

// Debugging to check props received
console.log("Received bank:", props);
</script>
